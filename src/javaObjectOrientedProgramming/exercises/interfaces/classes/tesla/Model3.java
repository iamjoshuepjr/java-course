...
import javaObjectOrientedProgramming.exercises.interfaces.classes.tesla.interfaces.*;
import javax.swing.JOptionPane;

public class Model3 extends Car implements ElectricVehicle, AutonomousDriving {
    public Model3(String vin) {
        super("Model3", vin);
    }
